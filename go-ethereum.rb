...
class GoEthereum < Formula
  ...
  bottle do
    revision 140
    root_url 'https://build.ethdev.com/builds/OSX%20Go%20master%20brew/140/bottle'
    sha1 '86bf2636a491c137d8b0f6a9132543befbecb2dd' => :yosemite
  end

  devel do
    bottle do
      revision 228
      root_url 'https://build.ethdev.com/builds/OSX%20Go%20develop%20brew/228/bottle'
      sha1 'f404f230f91a38d2f245e492b36d391501acb863' => :yosemite
    end
