...
class GoEthereum < Formula
  ...
  bottle do
    revision 138
    root_url 'https://build.ethdev.com/builds/OSX%20Go%20master%20brew/138/bottle'
    sha1 'c1cc9f98f5a15fefd58fcd92ea3711f9284ee317' => :yosemite
  end

  devel do
    bottle do
      revision 219
      root_url 'https://build.ethdev.com/builds/OSX%20Go%20develop%20brew/219/bottle'
      sha1 'b14f73a23b1f70de428240b169dbf4fb2311c8bc' => :yosemite
    end
