...
class CppEthereum < Formula
  ...
  bottle do
    revision 167
    root_url 'https://build.ethdev.com/builds/OSX%20C%2B%2B%20master%20brew/167/bottle'
    sha1 '963efba71d34327b5aaaf19e0853d73dc1a16e73' => :yosemite
  end

  devel do
    bottle do
      revision 1052
      root_url 'https://build.ethdev.com/builds/OSX%20C%2B%2B%20develop%20brew/1052/bottle'
      sha1 '57d92806c77750e74be33758b264ebfa5156a994' => :yosemite
    end

    if build.include? "successful"
      version '0.9.38-61'
      url 'https://github.com/ethereum/cpp-ethereum.git', :revision => 'ac46a773f4b8d162756c7fd913e5d0ed7f0a56c3'
    else
    version '0.9.38-61'
