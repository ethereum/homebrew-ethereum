...
class CppEthereum < Formula
  ...
  bottle do
    revision 22
    root_url 'http://52.28.164.97/job/ethbinaries-build/label=macosx_slave/22/artifact/webthree-umbrella/build'
    sha1 '799f94443dd77b49eb2165db7ec84ad07eee1f18' => :yosemite
  end
