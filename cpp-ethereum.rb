...
class CppEthereum < Formula
  ...
  bottle do
    revision 165
    root_url 'https://build.ethdev.com/builds/OSX%20C%2B%2B%20master%20brew/165/bottle'
    sha1 '97baffbb5a481cf34d29b418ae2be96b35d76389' => :yosemite
  end

  devel do
    bottle do
      revision 1047
      root_url 'https://build.ethdev.com/builds/OSX%20C%2B%2B%20develop%20brew/1047/bottle'
      sha1 'df0a24b650879d30b6b1a237605ecf0c3a975eb4' => :yosemite
    end

    if build.include? "successful"
      version '0.9.38-61'
      url 'https://github.com/ethereum/cpp-ethereum.git', :revision => '6673829d803caba6f9e82545482f2cfc1910136e'
    else
    version '0.9.38-61'
