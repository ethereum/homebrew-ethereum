...
class CppEthereum < Formula
  ...
  bottle do
    revision 166
    root_url 'https://build.ethdev.com/builds/OSX%20C%2B%2B%20master%20brew/166/bottle'
    sha1 'd4c46e819ed190b81e51ca6ec78c4948ee153cbc' => :yosemite
  end

  devel do
    bottle do
      revision 1048
      root_url 'https://build.ethdev.com/builds/OSX%20C%2B%2B%20develop%20brew/1048/bottle'
      sha1 '7a6148ae5ac2a494c96844b74663189c468b1e7d' => :yosemite
    end

    if build.include? "successful"
      version '0.9.38-61'
      url 'https://github.com/ethereum/cpp-ethereum.git', :revision => 'e63efbd1b7e80b5d70bc6cc0ab537257298f52e9'
    else
    version '0.9.38-61'
