...
class CppEthereum < Formula
  ...
  bottle do
    revision 26
    root_url 'http://52.28.164.97/job/ethbinaries-build/label=macosx_slave/26/artifact/webthree-umbrella/build'
    sha1 '6ba13b325f7024b91c7becc87851a5b1d3ca2bc7' => :yosemite
  end
