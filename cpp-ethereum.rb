...
class CppEthereum < Formula
  ...
  bottle do
    revision 34
    root_url 'http://52.28.164.97/job/ethbinaries-build/label=macosx_slave/34/artifact/webthree-umbrella/build'
    sha1 '84d3c8f5baafe5ee6e185b27bd02bcd2327a765f' => :yosemite
  end
