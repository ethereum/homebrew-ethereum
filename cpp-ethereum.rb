...
class CppEthereum < Formula
  ...
  bottle do
    revision 21
    root_url 'http://52.28.164.97/job/ethbinaries-build/label=macosx_slave/21/artifact/webthree-umbrella/build'
    sha1 'e9ecfae93ce8f8cc31afc374768a519bb8881b2a' => :yosemite
  end
