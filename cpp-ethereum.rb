...
class CppEthereum < Formula
  ...
  bottle do
    revision 29
    root_url 'http://52.28.164.97/job/ethbinaries-build/label=macosx_slave/29/artifact/webthree-umbrella/build'
    sha1 'f48379fa8322622f8b7cc2fe16ed597b51096b0c' => :yosemite
  end
