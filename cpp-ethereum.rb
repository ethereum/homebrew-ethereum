...
class CppEthereum < Formula
  ...
  bottle do
    revision 164
    root_url 'https://build.ethdev.com/builds/OSX%20C%2B%2B%20master%20brew/164/bottle'
    sha1 '01708239ac195bf1dd5e491ddf4b9fc2b1c9ad4b' => :yosemite
  end

  devel do
    bottle do
      revision 1046
      root_url 'https://build.ethdev.com/builds/OSX%20C%2B%2B%20develop%20brew/1046/bottle'
      sha1 'b4fd9c424fa5419e0f516475853b6d165f985f60' => :yosemite
    end

    if build.include? "successful"
      version '0.9.37-61'
      url 'https://github.com/ethereum/cpp-ethereum.git', :revision => '1ab43ab05971f61fe9b5b631c4f775a6d5a48ec5'
    else
    version '0.9.38-61'
