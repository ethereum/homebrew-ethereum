...
class CppEthereum < Formula
  ...
  bottle do
    revision 17
    root_url 'http://52.28.164.97/job/ethbinaries-build/label=macosx_slave/17/artifact/webthree-umbrella/build'
    sha1 '8f43c21df0e83863851b5d8a20f5086de3e2eafd' => :yosemite
  end
