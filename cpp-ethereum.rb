...
class CppEthereum < Formula
  ...
  bottle do
    revision 33
    root_url 'http://52.28.164.97/job/ethbinaries-build/label=macosx_slave/33/artifact/webthree-umbrella/build'
    sha1 'd7a908598430d724e5e80ca37a344741e59d420c' => :yosemite
  end
