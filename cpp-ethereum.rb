...
class CppEthereum < Formula
  ...
  bottle do
    revision 172
    root_url 'https://build.ethdev.com/builds/OSX%20C%2B%2B%20master%20brew/172/bottle'
    sha1 '832e3a8b911237403b63ed6fbba8942b36877d08' => :yosemite
  end

  devel do
    bottle do
      revision 1104
      root_url 'https://build.ethdev.com/builds/OSX%20C%2B%2B%20develop%20brew/1104/bottle'
      sha1 '7840eef24a29227f1bc09982aee869efca78b37e' => :yosemite
    end

    if build.include? "successful"
      version '0.9.41-61'
      url 'https://github.com/ethereum/cpp-ethereum.git', :revision => '0e1ae31574bfe32b7bea6b5996e5023c494f64de'
    else
    version '0.9.41-61'
