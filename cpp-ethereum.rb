...
class CppEthereum < Formula
  ...
  bottle do
    revision 18
    root_url 'http://52.28.164.97/job/ethbinaries-build/label=macosx_slave/18/artifact/webthree-umbrella/build'
    sha1 '1f3e0b0bb5c52e0b789213022a646de3caf22426' => :yosemite
  end
