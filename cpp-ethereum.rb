...
class CppEthereum < Formula
  ...
  bottle do
    revision 163
    root_url 'https://build.ethdev.com/builds/OSX%20C%2B%2B%20master%20brew/163/bottle'
    sha1 '17857f0f6f3bd150a62e1fe4db2b777b7801b799' => :yosemite
  end

  devel do
    bottle do
      revision 1045
      root_url 'https://build.ethdev.com/builds/OSX%20C%2B%2B%20develop%20brew/1045/bottle'
      sha1 '236e766121cacbd5fd266ea37580bbfac70cb3e5' => :yosemite
    end

    if build.include? "successful"
      version '0.9.37-61'
      url 'https://github.com/ethereum/cpp-ethereum.git', :revision => 'c466eb6b2cf4de8df4d366d505583540443da312'
    else
    version '0.9.37-61'
