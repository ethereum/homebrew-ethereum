...
class CppEthereum < Formula
  ...
  bottle do
    revision 169
    root_url 'https://build.ethdev.com/builds/OSX%20C%2B%2B%20master%20brew/169/bottle'
    sha1 'aa01b05b8fd9052d1b003a39dc6108d13d9ca7bb' => :yosemite
  end

  devel do
    bottle do
      revision 1072
      root_url 'https://build.ethdev.com/builds/OSX%20C%2B%2B%20develop%20brew/1072/bottle'
      sha1 'af359dfff0a40d9aa07f302ecbaea35ac0ddd3ae' => :yosemite
    end

    if build.include? "successful"
      version '0.9.38-61'
      url 'https://github.com/ethereum/cpp-ethereum.git', :revision => 'f23a60c7045da07b124efe3ee77ff389c0ec36b4'
    else
    version '0.9.39-61'
