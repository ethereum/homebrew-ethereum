...
class CppEthereum < Formula
  ...
  bottle do
    revision 15
    root_url 'http://52.28.164.97/job/ethbinaries-build/label=macosx_slave/15/artifact/webthree-umbrella/build'
    sha1 'eec0765f08b9f7a8bcb598884d8a66f2d7111a42' => :yosemite
  end
