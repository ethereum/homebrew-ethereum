...
class CppEthereum < Formula
  ...
  bottle do
    revision 19
    root_url 'http://52.28.164.97/job/ethbinaries-build/label=macosx_slave/19/artifact/webthree-umbrella/build'
    sha1 'f65bd1b16961bee8839f8179bc5f8eaa994694c9' => :yosemite
  end
