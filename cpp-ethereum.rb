...
class CppEthereum < Formula
  ...
  bottle do
    revision 30
    root_url 'http://52.28.164.97/job/ethbinaries-build/label=macosx_slave/30/artifact/webthree-umbrella/build'
    sha1 'f4942c11b8cb8c13cd3baefa824f48ad5420151d' => :yosemite
  end
