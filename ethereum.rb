...
class Ethereum < Formula
  ...
  bottle do
    revision 151
    root_url 'https://build.ethdev.com/builds/OSX%20Go%20master%20brew/151/bottle'
    sha1 '132dada5a9fdceff7bbb0376b33e9811b12c6e9d' => :yosemite
  end

  devel do
    bottle do
      revision 579
      root_url 'https://build.ethdev.com/builds/OSX%20Go%20develop%20brew/579/bottle'
      sha1 'af0082d96fa8fc196cc04b8a2a6312bb0a572976' => :yosemite
    end
