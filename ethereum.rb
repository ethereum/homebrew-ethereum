...
class Ethereum < Formula
  ...
  bottle do
    revision 168
    root_url 'https://build.ethdev.com/builds/OSX%20Go%20master%20brew/168/bottle'
    sha1 '3235b29c1d42e3acdf28c52cc0043b3c08fad905' => :yosemite
  end

  devel do
    bottle do
      revision 726
      root_url 'https://build.ethdev.com/builds/OSX%20Go%20develop%20brew/726/bottle'
      sha1 'c7605dc0a2f1d73a2ef6c3debb6517ff65aa8cd7' => :yosemite
    end
