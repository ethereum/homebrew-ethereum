...
class Ethereum < Formula
  ...
  bottle do
    revision 132
    root_url 'http://build.ethdev.com/builds/OSX%20C%2B%2B%20master%20brew/132/bottle'
    sha1 'fea1ca745f13540b845df10d283634526f3dc41b' => :yosemite
  end

  devel do
    bottle do
      revision 136
      root_url 'http://build.ethdev.com/builds/OSX%20C%2B%2B%20develop%20brew/136/bottle'
      sha1 '49280ee3439333cfc395960165f4f9797fd8e440' => :yosemite
    end

    if build.include? "successful"
      version '0.7.13-49-5'
      url 'https://github.com/ethereum/cpp-ethereum.git', :revision => 'b9d76de55f4396c8307d012267bc6b83ace30f26'
    else
    version '0.7.13-49-5'
