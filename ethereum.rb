...
class Ethereum < Formula
  ...
  bottle do
    revision 164
    root_url 'https://build.ethdev.com/builds/OSX%20Go%20master%20brew/164/bottle'
    sha1 'b626755f56b284c51e7c1e3df5812362568e7ab8' => :yosemite
  end

  devel do
    bottle do
      revision 697
      root_url 'https://build.ethdev.com/builds/OSX%20Go%20develop%20brew/697/bottle'
      sha1 '1a74dfd52f9c742617877cc42ea36eb2f92b6ebb' => :yosemite
    end
