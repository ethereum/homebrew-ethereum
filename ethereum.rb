...
class Ethereum < Formula
  ...
  bottle do
    revision 147
    root_url 'https://build.ethdev.com/builds/OSX%20Go%20master%20brew/147/bottle'
    sha1 'e09102acefb6f7a07af6c41807e61d3e1dc688bb' => :yosemite
  end

  devel do
    bottle do
      revision 554
      root_url 'https://build.ethdev.com/builds/OSX%20Go%20develop%20brew/554/bottle'
      sha1 'f842edd3ee159107809c961448066d93ecda8994' => :yosemite
    end
