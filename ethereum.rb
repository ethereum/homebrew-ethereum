...
class Ethereum < Formula
  ...
  bottle do
    revision 149
    root_url 'https://build.ethdev.com/builds/OSX%20Go%20master%20brew/149/bottle'
    sha1 'c7837f5a926585e3d774529327122f724aed7edb' => :yosemite
  end

  devel do
    bottle do
      revision 558
      root_url 'https://build.ethdev.com/builds/OSX%20Go%20develop%20brew/558/bottle'
      sha1 '55131cbeece2731d4b329b2e22ba15bc1f886ab6' => :yosemite
    end
