...
class Ethereum < Formula
  ...
  bottle do
    revision 143
    root_url 'https://build.ethdev.com/builds/OSX%20Go%20master%20brew/143/bottle'
    sha1 '320c39daf1692457919fe6cae71da7e87f551cd6' => :yosemite
  end

  devel do
    bottle do
      revision 523
      root_url 'https://build.ethdev.com/builds/OSX%20Go%20develop%20brew/523/bottle'
      sha1 'bebcf48a4e2c56eb699878e323c1c246192c1a28' => :yosemite
    end
