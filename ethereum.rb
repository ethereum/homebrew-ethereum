...
class Ethereum < Formula
  ...
  bottle do
    revision 172
    root_url 'https://build.ethdev.com/builds/OSX%20Go%20master%20brew/172/bottle'
    sha1 '8048741641ddbc70b7600fb896dcd5417ca5416a' => :yosemite
  end

  devel do
    bottle do
      revision 756
      root_url 'https://build.ethdev.com/builds/OSX%20Go%20develop%20brew/756/bottle'
      sha1 'c5297baf0e89b706d813209cce08ebd239e38951' => :yosemite
    end
