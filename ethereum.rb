...
class Ethereum < Formula
  ...
  bottle do
    revision 146
    root_url 'https://build.ethdev.com/builds/OSX%20Go%20master%20brew/146/bottle'
    sha1 'c55074690b27f5b9e2fe2dd5da6db859a0c613a0' => :yosemite
  end

  devel do
    bottle do
      revision 541
      root_url 'https://build.ethdev.com/builds/OSX%20Go%20develop%20brew/541/bottle'
      sha1 'b97df585458225207c1ec492955a14b729391061' => :yosemite
    end
