...
class Ethereum < Formula
  ...
  bottle do
    revision 144
    root_url 'https://build.ethdev.com/builds/OSX%20Go%20master%20brew/144/bottle'
    sha1 '04cefe9be6e1bc06ac63f7703ce8703d3328653f' => :yosemite
  end

  devel do
    bottle do
      revision 524
      root_url 'https://build.ethdev.com/builds/OSX%20Go%20develop%20brew/524/bottle'
      sha1 'e40790f4d66d0ce972a6ff465b4f2322edc50b74' => :yosemite
    end
